							...
							<ul class="menu-container">
								...
								<li class="menu-item"><a class="menu-link" href="demo-movers-rates.php"><div>Rates</div></a>
									<ul class="sub-menu-container">
										<li class="menu-item"><a class="menu-link" href="demo-movers-rates.php"><div><i class="icon-line2-home"></i>Home Moving</div></a></li>
										<li class="menu-item"><a class="menu-link" href="demo-movers-rates.php"><div><i class="icon-building2"></i>Office Moving</div></a></li>
										<li class="menu-item"><a class="menu-link" href="demo-movers-rates.php"><div><i class="icon-line2-globe"></i>International Moving</div></a></li>
										<li class="menu-item"><a class="menu-link" href="demo-movers-rates.php"><div><i class="icon-paw"></i>Pet Shifting</div></a></li>
										<li class="menu-item"><a class="menu-link" href="demo-movers-rates.php"><div><i class="icon-car"></i>Car Shifting</div></a></li>
										<li class="menu-item"><a class="menu-link" href="demo-movers-rates.php"><div><i class="icon-truck1"></i>Hire Truck</div></a></li>
									</ul>
								</li>
			...
			<div class="content-wrap pb-0">
				...
				<div class="container mb-5">
					<div class="heading-block">
						<h3 class="nott mb-3 font-weight-semibold ls0">Our Leadership</h3>
					</div>
					<div class="row col-mb-50 mb-0">
						...
						<div class="col-lg-3 col-md-6">
							...
							<div class="team">
								<div class="team-image">
									<img src="./movers/images/team/1.jpg" alt="John Doe">
								</div>
								<div class="team-desc text-left">
									<div class="team-title">
										<h4 class="nott ls0 font-weight-semibold">John Doe</h4>
										<h5 class="font-weight-medium color mb-0">CEO</h5>
									</div>
								</div>
							</div>
						...
						<div class="col-lg-3 col-md-6">
							...
							<div class="team">
								<div class="team-image">
									<img src="./movers/images/team/2.jpg" alt="Josh Clark">
								</div>
								<div class="team-desc text-left">
									<div class="team-title">
										<h4 class="nott ls0 font-weight-semibold">Josh Clark</h4>
										<h5 class="font-weight-medium color mb-0">Co-Founder</h5>
									</div>
								</div>
							</div>
						...
						<div class="col-lg-3 col-md-6">
							...
							<div class="team">
								<div class="team-image">
									<img src="./movers/images/team/3.jpg" alt="Barry Tone">
								</div>
								<div class="team-desc text-left">
									<div class="team-title">
										<h4 class="nott ls0 font-weight-semibold">Barry Tone</h4>
										<h5 class="font-weight-medium color mb-0">Manager</h5>
									</div>
								</div>
							</div>
						...
						<div class="col-lg-3 col-md-6">
							...
							<div class="team">
								<div class="team-image">
									<img src="./movers/images/team/4.jpg" alt="Jackson Pot">
								</div>
								<div class="team-desc text-left">
									<div class="team-title">
										<h4 class="nott ls0 font-weight-semibold">Jackson Pot</h4>
										<h5 class="font-weight-medium color mb-0">Financer</h5>
									</div>
								</div>
							</div>
						...
						<div class="col-lg-3 col-md-6">
							...
							<div class="team">
								<div class="team-image">
									<img src="./movers/images/team/5.jpg" alt="Lance Bogrol">
								</div>
								<div class="team-desc text-left">
									<div class="team-title">
										<h4 class="nott ls0 font-weight-semibold">Lance Bogrol</h4>
										<h5 class="font-weight-medium color mb-0">Support</h5>
									</div>
								</div>
							</div>
						...
						<div class="col-lg-3 col-md-6">
							...
							<div class="team">
								<div class="team-image">
									<img src="./movers/images/team/6.jpg" alt="Weir Doe">
								</div>
								<div class="team-desc text-left">
									<div class="team-title">
										<h4 class="nott ls0 font-weight-semibold">Weir Doe</h4>
										<h5 class="font-weight-medium color mb-0">Support</h5>
									</div>
								</div>
							</div>
						...
						<div class="col-lg-3 col-md-6">
							...
							<div class="team">
								<div class="team-image">
									<img src="./movers/images/team/7.jpg" alt="Fletch Skinner">
								</div>
								<div class="team-desc text-left">
									<div class="team-title">
										<h4 class="nott ls0 font-weight-semibold">Fletch Skinner</h4>
										<h5 class="font-weight-medium color mb-0">Delivery Boy</h5>
									</div>
								</div>
							</div>
						...
						<div class="col-lg-3 col-md-6">
							...
							<div class="team">
								<div class="team-image">
									<img src="./movers/images/team/8.jpg" alt="Desmond Eagle">
								</div>
								<div class="team-desc text-left">
									<div class="team-title">
										<h4 class="nott ls0 font-weight-semibold">Desmond Eagle</h4>
										<h5 class="font-weight-medium color mb-0">Delivery Boy</h5>
									</div>
								</div>
							</div>
						...
						<div class="col-lg-3 col-md-6">
							...
							<div class="team">
								<div class="team-image">
									<img src="./movers/images/team/9.jpg" alt="Brian Cumin">
								</div>
								<div class="team-desc text-left">
									<div class="team-title">
										<h4 class="nott ls0 font-weight-semibold">Brian Cumin</h4>
										<h5 class="font-weight-medium color mb-0">Delivery Boy</h5>
									</div>
								</div>
							</div>
					...
					<div class="container">
						<div class="row justify-content-between align-items-center">
							...
							<div class="col-md-5" style="transform: translateY(-45px)">
								<img src="./movers/images/team/section.jpg" alt="John Doe">
							</div>
						</div>
					</div>
				...
				<div class="section dark pt-0 m-0 bg-color" style="background: url('./movers/images/bg-2.png') no-repeat center bottom / 100%; overflow: visible">
					...
					<div class="container">
						<div class="row align-items-center justify-content-center center my-4">
							...
							<div class="col-sm-8">
								...
								<a href="demo-movers-contact.php" class="button button-white button-light button-rounded font-weight-medium m-0">Get In Touch</a>
							</div>
