...
$currentAmount = 0.5 * $sum;
$remainderAmount = $sum - $currentAmount;

$_SESSION["currentAmount"] = $currentAmount;
$_SESSION["remainderAmount"] = $remainderAmount;
	...
	<div id="wrapper" class="clearfix">
		...
		<section id="page-title" class="bg-color page-title-dark py-6">
			...
			<div class="container clearfix">
				...
				<span>If there is no problem, kindly proceed to payment</span>
				<ol class="breadcrumb">
						...
						<div class="col-lg-12 mb-12 mb-lg-12">
                            <div class="invoice-box">
								<table cellpadding="0" cellspacing="0">
									...
									<tr class="total">
										<td></td>
										<td>Total: RM <?php echo $currentAmount; ?></td>
									</tr>
								</table>
								<a class="col-12 button button-rounded btn-block" href="booking.php" type="button" id="template-contactform-submit" style="text-align:center;" name="nextButton">GO BACK</a>
								<form action="./payment.php" method="post">								
									<button class="col-12 button button-rounded btn-block" type="submit" id="template-contactform-submit" name="nextButton" value="submit">Proceed to Payment</button>
								</form>
							</div>
						</div>
					</div>
