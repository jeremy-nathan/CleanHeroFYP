	...
	<div id="wrapper" class="clearfix">
					...
					<div class="header-row justify-content-between flex-row-reverse flex-lg-row">
						...
						<nav class="primary-menu with-arrows not-dark">
							...
							<ul class="menu-container">
								...
								<li class="menu-item current"><a class="menu-link" href="demo-movers-rates.php"><div>Rates</div></a></li>
								<li class="menu-item"><a class="menu-link" href="demo-movers-contact.php"><div>Support</div></a></li>
							</ul>
		...
		<section id="content">
			...
			<div class="content-wrap p-0">
				...
				<!-- <div id="slider" class="section bg-color mt-0" style="padding: 60px 0; background: url('./movers/images/bg-2.png') no-repeat center center / 100% 100%;">
									...
									<div class="tab-pane fade show active" id="home-moving" role="tabpanel" aria-labelledby="home-moving-tab">
										...
										<div class="form-widget">
											...
											<form class="row home-moving-form position-relative mb-0" action="include/form.php" method="post" enctype="multipart/form-data">
												...
												<div class="col-12">
													<button type="submit" name="home-moving-form-submit" class="btn bg-color text-white font-weight-medium btn-block py-2 mt-2">Get a Quote</button>
												</div>
									...
									<div class="tab-pane fade" id="office-moving" role="tabpanel" aria-labelledby="office-moving-tab">
										...
										<div class="form-widget">
											...
											<form class="row office-moving-form position-relative mb-0" action="include/form.php" method="post" enctype="multipart/form-data">
												...
												<div class="col-12">
													<button type="submit" name="office-moving-form-submit" class="btn bg-color text-white font-weight-medium btn-block py-2 mt-2">Get a Quote</button>
												</div>
									...
									<div class="tab-pane fade" id="others-moving" role="tabpanel" aria-labelledby="others-moving-tab">
										<div class="form-widget">
											...
											<form class="row others-moving-form position-relative mb-0" action="include/form.php" method="post" enctype="multipart/form-data">
												...
												<div class="col-12">
													<button type="submit" name="others-moving-form-submit" class="btn bg-color text-white font-weight-medium btn-block py-2 mt-2">Get a Quote</button>
												</div>
				...
				<div style="margin-top:20px;" class="container mb-4">
					<h4 class="text-center">Approx. Packers and Movers Charges and Rates</h4>
					<div class="table-responsive">
						<table class="table table-bordered">
							<thead class="thead-dark">
								<tr>
									<th class="font-weight-semibold">Items/Descriptions</th>
									<th class="font-weight-semibold">Upto 200KM</th>
									<th class="font-weight-semibold">200 -500KM</th>
									<th class="font-weight-semibold">500 - 700KM</th>
									<th class="font-weight-semibold">700 - 1000Km</th>
									<th class="font-weight-semibold">Out of City</th>
								</tr>
							</thead>
							<tbody>
								<tr>
									<td class="font-weight-semibold">1BHK Flat</td>
								...
								<tr>
									<td class="font-weight-semibold">2BHK Flat</td>
								...
								<tr>
									<td class="font-weight-semibold">3BHK Flat</td>
								...
								<tr>
									<td class="font-weight-semibold">Labour Charges</td>
								...
								<tr>
									<td class="font-weight-semibold">Office Shifting</td>
									<td>&dollar;20 - &dollar;30</td>
									<td>&dollar;30 - &dollar;40</td>
									<td>&dollar;45 - &dollar;60</td>
									<td>&dollar;45 - &dollar;60</td>
								...
								<tr>
									<td class="font-weight-semibold">Pet Shifting</td>
								...
								<tr>
									<td class="font-weight-semibold">Full Home Shifing</td>
									<td>&dollar;43 - &dollar;70</td>
					...
					<div class="row justify-content-between align-items-center">
						...
						<div class="col-md-6 d-md-flex flex-md-column align-items-md-end mt-4 mt-md-0">
							<div class="copyrights-menu copyright-links text-black-50 clearfix">
								<a href="demo-movers-rates.php">Rates</a>/<a href="demo-movers-contact.php">Contact</a>
							</div>
						</div>
					</div>
