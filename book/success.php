...
if(!empty($_GET["tid"])){
	...
	$_SESSION["tid"] = $GET["tid"];
	
	$email = $_SESSION["email"];
	$to_email = $_SESSION["email"];
	$subject = "DO NOT REPLY";
	$body = '<h2>Hi '.$_SESSION["fullName"].' !</h2>';
	$body .= '<p>Thank you for your booking</p>';
	$body .= '<p>Your booking ID is <b>'.$_SESSION["tid"].'</b></p>';
	$headers = "From: jeremy.nathan1@gmail.com";
				...
				<div class="container mb-12">
					<div class="row justify-content-between">
						<div class="col-lg-12 mb-12 mb-lg-12">
							<h3>Thank you for your booking! We have sent you an email containing your booking details.</h3>
                            <h4>Your Booking ID : <?php echo $_SESSION["tid"]; ?></h4>
                            <h5>Disclaimer : As of now, only half of the full price has been paid. Kindly pay the remainder upon completion. Your cooperation is greatly appreciated</h5>
							<!-- <h4>To go back to the home page, please click the button below</h3> -->
                            <a style="display:none; margin-bottom:20px;" href="index.php" id="backButton" class="btn bg-color text-white">Go Back</a>
                            <form action="redirect.php" method="post" target="_blank">
                                <button id="invoiceButton" type="submit" onclick="appear()" class="btn bg-color btn-block text-white">Download Invoice</a>                            
                            </form>
						</div>
					</div>
				</div>
