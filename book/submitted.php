...
if(isset($_POST["submitButton"])){
    ...
    $complaints->createDocument($_POST["bookingID"], $complaintData);
					...
					<div class="header-row justify-content-between flex-row-reverse flex-lg-row">
						...
						<nav class="primary-menu with-arrows not-dark">
							...
							<ul class="menu-container">
								...
								<li class="menu-item"><a class="menu-link" href="demo-movers-rates.php"><div>Rates</div></a></li>
				...
				<div class="container mb-12">
					<div class="row justify-content-between">
						<div class="col-lg-12 mb-12 mb-lg-12">
							<h3>Your review has been submitted. Our team will get in touch with as soon as possible</h3>
							<h4>To go back to the home page, please click the button below</h4>
                            <a href="index.php" id="backButton" class="btn bg-color text-white">Go Back</a>
						</div>
					</div>
				</div>
