...
$cleaner = new Firestore("Cleaners");
...
if(isset($_POST['login'])) {
  ...
  $result = $cleaner->getCompositeWhere("ID","Password","==","==",$username,$password);
  if(count($result) == 1) {
...
<head>
    ...
    <title>CleanHero Cleaner Login</title>
            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <h1 class="">Log In to <span class="brand-name">Clean Hero</span></h1>
                        <form class="text-left" method="POST" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
                            <div class="form">
                                ...
                                <div id="username-field" class="field-wrapper input">
                                    ...
                                    <input id="username" name="username" type="text" class="form-control" placeholder="Your ID">
                                </div>
